...
SECRET_KEY = 'django-insecure-dz=#=#kjlo6td04-k!)i)v+v^hf!$t3#gb3oz6^=6jq-wdunxm'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=30),  # Ajusta el tiempo según tus necesidades
